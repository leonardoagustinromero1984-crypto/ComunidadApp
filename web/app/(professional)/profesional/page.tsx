...
export default function ProfessionalPlaceholderPage() {
  return (
    <section className="flex flex-1 flex-col gap-4 py-12">
      <Card>
        <h1 className="text-2xl font-bold">Portal profesional</h1>
        <p className="mt-2 text-brand-text/80">
          Área reservada para el portal veterinario M28. Próximamente.
        </p>
