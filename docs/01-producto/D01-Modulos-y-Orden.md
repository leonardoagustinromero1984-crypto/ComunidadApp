...
- **M16 Refugios y gestión de casos:** … **M17 Donaciones cerrado oficialmente** (2026-08-02); **M18 Bloque 2 implementado** (058 no aplicada).
...
- **M18 Eventos:** creación, cupos, inscripción, recordatorios y check-in — **Bloque 1 cerrado localmente**; **Bloque 2 implementado** (migración 058 creada, **no aplicada**; mock + Supabase RPC).
