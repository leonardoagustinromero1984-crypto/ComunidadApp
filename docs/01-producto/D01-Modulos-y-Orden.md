...
- **M20 Mensajería:** conversaciones, adjuntos, bloqueos, contexto y retención — **Bloques 1–3 implementados localmente** (mock + persistencia SQL 062 **no aplicada**); **Bloque 4 pendiente**; **no cerrado**.
