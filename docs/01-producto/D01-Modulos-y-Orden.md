...
- **M16 Refugios y gestión de casos:** animales, equipos, necesidades, tareas y reportes — **M16 en desarrollo**; **M16 Bloque 1 cerrado oficialmente** (aceptación responsable del proyecto, 2026-08-01); **M16 Bloque 2 en desarrollo** (persistencia remota); Bloque 3 pendiente; **M16 completo: no**.
