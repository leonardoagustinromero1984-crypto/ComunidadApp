...
- **M13 técnico (Avistamientos y coincidencias)** — **BLOQUE 2 CERRADO LOCALMENTE**; migración **048** creada y **pendiente de aplicación remota**. Enriquece Lost/Found legacy (ADR-013). M12 smoke funcional sigue **PENDIENTE EXTERNO**; M12 cierre oficial **PENDIENTE**.
