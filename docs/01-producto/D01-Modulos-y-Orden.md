...
### R6 — Servicios
- **M22 Prestadores y catálogo de servicios:** perfil, sedes, categorías, cobertura y precios — **Bloque 1 implementado localmente** (mock, sin SQL ni wiring Supabase); **Bloque 2 pendiente**.
