...
- **Producto M14 Adopciones** = cubierto por **M09 técnico**. **M14 técnico** = Pasaporte e identidad verificable. **M14 BLOQUE 1 CERRADO LOCALMENTE**. **M14 BLOQUE 2 CERRADO LOCALMENTE** (migración 050 creada, **PENDIENTE DE APLICACIÓN REMOTA**). M15 no iniciado.
