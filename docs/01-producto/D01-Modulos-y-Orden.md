...
- **Producto M14 Adopciones** = cubierto por **M09 técnico**. **M14 técnico** = Pasaporte e identidad verificable. **M14 BLOQUE 1 CERRADO LOCALMENTE**. **M14 BLOQUE 2 CERRADO LOCALMENTE** (050 y 051 **aplicadas remotamente**; validación estructural final **pendiente de confirmación**). M15 no iniciado.
