    ...
    Scaffold(
        ...
        HorizontalPager(
            ...
            when (page) {
                ...
                3 -> AdoptionEventsContent(onM18Events = onM18Events, onM19Feed = onM19Feed)
                4 -> SheltersContent(
                    onShelterClick = onShelterClick,
                    onShelterOps = onShelterOps,
                    onVeterinaryDirectory = onVeterinaryDirectory,
                    onM16Shelters = onM16Shelters
                )
                5 -> DonationsContent(onM17Campaigns = onM17Campaigns)
            }
        }
    }
}
